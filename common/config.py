...
argparser.add_argument("--aFreezeBackbone", action = "store_true", help = "Freeze the Whisper backbone in the audio branch")
...
argparser.add_argument("--vFreezeBackbone", action = "store_true", help = "Freeze the backbone in the vision branch")
